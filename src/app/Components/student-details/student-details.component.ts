...
export class StudentDetailsComponent implements OnInit {
  ...
  async LoadClient()
  {
   this.student=await new Student(
      ...
      2,
      this.route.snapshot.paramMap.get('student.status'),
    )
  ...
  OpenStudentPayDetails(){
    ...
    this.router.navigateByUrl("students-list/(studentDetailsRouterOutlet:student-details/(studentPayDetailsRouterOutlet:student-pay-details))");
  }
